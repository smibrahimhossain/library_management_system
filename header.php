...
<body class="sb-nav-fixed">
    ...
    ?>
                ...
                <body>
                    ...
                    <!-- <main style="background:#3d2928 "> -->
                    <main style="background-image: url('upload/l4.jpg');">
                        ...
                        <div class="container">
                                ...
                                <div class="row ">
                                    <div class="col-md-6">
                                        <a href="index.php"
                                            ...
                                            <span class="fs-4 text-white " style="margin-left:4%    ">Library
                                                Management
                                                System</span>
                                        </a>
                                    </div>
                            ...
                            ?>
                                        <ul class="list-inline mt-4 float-end">
                                            <li class="list-inline-item"><?php echo $_SESSION['user_id']; ?>
                                            </li>
                                            <li class="list-inline-item"><a href="issue_book_details.php">Issue
                                                    Book</a>
                                            </li>
                                            <li class="list-inline-item"><a href="search_book.php">Search
                                                    Book</a></li>
